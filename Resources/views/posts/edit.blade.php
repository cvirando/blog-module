                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                            ...
                            <span class="float-end">
                                <a href="{{route('blogPosts')}}" class="btn btn-md btn-warning">Back</a>
                            </span>
                        </h5>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="radio" name="active" value="1" class="form-selectgroup-input" {{$post->active == '1' ? "checked" : ''}}>
                                ...
                                <div class="col-lg-6">
                                    <label class="form-selectgroup-item">
                                    <input type="radio" name="active" value="0" class="form-selectgroup-input" {{$post->active == '0' ? "checked" : ''}}>
                                    <span class="form-selectgroup-label d-flex align-items-center p-3">
                                        <span class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                        </span>
